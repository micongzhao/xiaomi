...
<html lang="zh-cn">
	...
	<body style="background-color: #f2f9fd;">
		<div class="header bg-main">
			<div class="logo margin-big-left fadein-top">
				<h1>
					<img src="images/6.jpg" class="radius-circle rotate-hover"
						height="60" alt="" />
					后台管理中心
				</h1>
			</div>
		...
		<div class="leftnav">
			...
			<ul style="display: block">
				<li>
					<a href="Administrator.jsp" target="right"><span
						class="icon-caret-right"></span>操作员管理</a>
				</li>
				<li>
					<a href="Administractor.jsp" target="right"><span
						class="icon-caret-right"></span>用户列表</a>
				</li>
				<li>
					<a href="Updatepass.jsp" target="right"><span
			...
			<ul>
				<li>
					<a href="Student.jsp" target="right"><span
				...
				<li>
					<a href="Select.jsp" target="right"><span
	...
	$(function() {
		...
		<ul class="bread">
			<li>
				<a href="http://www.baidu.com" target="right" class="icon-home"> 首页</a>
			</li>
			<li>
